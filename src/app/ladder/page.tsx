      ...
      >
        ...
        <div
          style={{
            ...
            display: "grid",
            gridTemplateColumns: "48px 1fr 72px 90px 90px 80px 80px 90px 72px",
            padding: "12px 20px",
          }}
        >
          {["#", "TEAM", "P", "Sets W", "Sets L", "G Won", "G Lost", "G Ratio", "PTS"].map((h) => (
            <div
              key={h}
              style={{
                fontSize: "0.7rem",
        ...
        {ladder.map((entry, index) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ textAlign: "center", color: "#9ca3af" }}>
                {entry.played === 0 ? "—" : entry.gamesWon}
              </div>
              <div style={{ textAlign: "center", color: "#9ca3af" }}>
                {entry.played === 0 ? "—" : entry.gamesLost}
              </div>
              <div style={{ textAlign: "center", color: "#9ca3af" }}>
                {entry.gamesWon === 0 && entry.gamesLost === 0
                  ? "—"
